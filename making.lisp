...
(defun make-label (text position &key (font :default) (size 12) (color gamekit.colors:+black+))
...
(defun make-button (position &key label (fill-color gamekit.colors:+black+) (hover-color gamekit.colors:+black+)
...
(defun make-panel (position &key width height children (fill-color gamekit.colors:+black+)
